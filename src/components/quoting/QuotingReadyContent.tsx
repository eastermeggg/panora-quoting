...
/* The "prêt à coter" content: how-to steps + cotation address + ideal email.
 * Shared by the quoting onboarding's last step (StepReady) AND the quoting
 * dashboard empty state, so both stay in sync. */
...
export function QuotingReadyContent({
  configuredExtranets,
}: {
